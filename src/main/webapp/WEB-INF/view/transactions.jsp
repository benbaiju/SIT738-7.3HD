...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        input, select { width: 100%; padding: 12px; border: 1px solid #cbd5e1; border-radius: 8px; margin-bottom: 16px; font-size: 14px; }
...
<div class="layout">
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <a class="active" href="${pageContext.request.contextPath}/transactions?userId=${userId}">Transactions</a>
    ...
    <main class="main">
        <div class="topbar">
            <div>
                <h1>Transactions</h1>
                <p>Record and review your bank transactions.</p>
            </div>
        ...
        <div class="grid">
            <div class="card">
                ...
                <form action="${pageContext.request.contextPath}/transactions/add" method="post">
                    ...
                    <input type="text" name="transactionReference" required>
            ...
            <div class="card">
                ...
                <div class="summary-grid">
                    <div class="summary">
                        ...
                        <strong>$<%= String.format("%.2f", totalIncome) %></strong>
                    </div>
                    <div class="summary">
                ...
                <div class="table-wrap">
                    <table>
                        ...
                        <% if (transactions != null && !transactions.isEmpty()) {
                            for (BankTransaction transaction : transactions) { %>
                            <tr>
                                <td><%= transaction.getTransactionReference() %></td>
                        ...
                        <% } } else { %>
                            <tr>
                                <td class="empty" colspan="6">No transactions recorded yet.</td>
                            </tr>
                        <% } %>
                    </table>
                </div>
